...
import { useTransitionMutation } from "@/hooks/api/UseExpense";

export function FormsTransition({ date, onClose }: { date: Date | undefined; onClose: () => void }) {
  const [form] = Form.useForm();
  const { mutate, isPending} = useTransitionMutation();
